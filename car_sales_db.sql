...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jun 2023 pada 19.24
...
(1, '::1', 'abidhusein@gmail.com', 1, '2023-06-29 16:52:56', 1),
(2, '::1', 'lahkok34', NULL, '2023-06-29 17:07:47', 0),
(3, '::1', 'ahmadsyukron@gmail.com', 2, '2023-06-29 17:10:03', 1);
...
(1, '2017-11-20-223112', 'Myth\\Auth\\Database\\Migrations\\CreateAuthTables', 'default', 'Myth\\Auth', 1688056753, 1);
...
--
-- Struktur dari tabel `salespeople`
--
...
(5, 1, NULL, NULL, NULL, NULL, '2023-06-29 13:45:47', '2023-06-29 13:45:47');
...
(1, 'abidhusein@gmail.com', 'seins12', '$2y$10$DdprDZpWHgA4FJtMtd.txeOcnPDKMZtJnTJlzQ2nTDhUS0aaniixu', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2023-06-29 16:52:27', '2023-06-29 16:52:27', NULL),
(2, 'ahmadsyukron@gmail.com', 'ahmad30', '$2y$10$vHAwbMAmGVOqQPzdJmmn9eexlKl2VJ45lhYgi/QkJtmTOSyOcs6JC', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2023-06-29 17:09:29', '2023-06-29 17:09:29', NULL);
...
--
-- Indeks untuk tabel `salespeople`
--
...
--
-- AUTO_INCREMENT untuk tabel `salespeople`
--
ALTER TABLE `salespeople`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
